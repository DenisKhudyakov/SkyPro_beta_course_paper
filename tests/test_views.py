...
def test_read_xls_file() -> None:
    """Тестовая функция, для функции генератора"""
    assert str(type(read_xls_file(PATH_XLS_FILE_WITH_OPERATION))) == "<class 'generator'>"


@patch("src.views.pd.read_excel")
def test_get_exel(mock_get: Any) -> None:
    """Тестовая функция получания датафрейма эксель файла"""
...
def test_get_stock_data_env_is_empty(mock_get: Any) -> None:
    """Тестовая функция проверки на пустоту"""
...
@patch("requests.get")
def test_stock_rates(mock_get: Any) -> Any:
    """Тестовая функция, проверки стоимости акции"""
...
@patch("requests.get")
def test_stock_rates_errors(mock_get: Any, error: Any) -> None:
...
@patch("src.views.os.getenv")
def test_currency_rates_is_empty(mock_get: Any) -> None:
    """Тестовая функция проверки на пустоту"""
    mock_get.return_value = None
...
@patch("requests.get")
def test_currency_rates(mock_get: Any) -> None:
